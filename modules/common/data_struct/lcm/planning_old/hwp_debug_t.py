...
import lcmtypes.obstacle_traj_t

class hwp_debug_t(object):
    __slots__ = ["utime", "obstacle_position", "obstacle_corner_position", "obstacle_traj", "obstacle_longitudinal_speed", "target_speed", "longitudinal_speed_ego", "left_lane_type", "right_lane_type", "cruising_counter", "cruising_mode", "jam_counter", "is_jam", "lane_condition", "traffic_flow_evaluation", "driver_lane_change_signal", "turn_light", "curve_index", "half_size_x", "half_size_y"]

    __typenames__ = ["int64_t", "common.point_2d_t", "common.point_2d_t", "lcmtypes.obstacle_traj_t", "float", "float", "float", "int64_t", "int64_t", "int64_t", "int64_t", "int64_t", "boolean", "boolean", "int64_t", "int64_t", "int64_t", "int64_t", "float", "float"]

    __dimensions__ = [None, [8], [8, 5], [8], [8], None, None, None, None, None, None, None, None, [3], None, None, None, None, [8], [8]]
    ...
    def __init__(self):
        ...
        self.obstacle_traj = [ lcmtypes.obstacle_traj_t() for dim0 in range(8) ]
        ...
        self.turn_light = 0
        self.curve_index = 0
        self.half_size_x = [ 0.0 for dim0 in range(8) ]
        self.half_size_y = [ 0.0 for dim0 in range(8) ]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(8):
            assert self.obstacle_traj[i0]._get_packed_fingerprint() == lcmtypes.obstacle_traj_t._get_packed_fingerprint()
            self.obstacle_traj[i0]._encode_one(buf)
        ...
        buf.write(struct.pack('>8f', *self.half_size_x[:8]))
        buf.write(struct.pack('>8f', *self.half_size_y[:8]))
    ...
    def _decode_one(buf):
        ...
        self.obstacle_traj = []
        for i0 in range(8):
            self.obstacle_traj.append(lcmtypes.obstacle_traj_t._decode_one(buf))
        ...
        self.half_size_x = struct.unpack('>8f', buf.read(32))
        self.half_size_y = struct.unpack('>8f', buf.read(32))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc3be5a6fbae87806+ common.point_2d_t._get_hash_recursive(newparents)+ common.point_2d_t._get_hash_recursive(newparents)+ lcmtypes.obstacle_traj_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
