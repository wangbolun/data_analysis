...
class example_t(object):
    __slots__ = ["timestamp", "position", "orientation", "num_ranges", "ranges", "name", "enabled", "test_result"]
    ...
    def _encode_one(self, buf):
        ...
        __test_result_encoded = self.test_result.encode('utf-8')
        buf.write(struct.pack('>I', len(__test_result_encoded)+1))
        buf.write(__test_result_encoded)
        buf.write(b"\0")
    ...
    def _decode_one(buf):
        ...
        __test_result_len = struct.unpack('>I', buf.read(4))[0]
        self.test_result = buf.read(__test_result_len)[:-1].decode('utf-8', 'replace')
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x5b5d50f174516195) & 0xffffffffffffffff
